...
N(OP_SentConfirm),
// Low level
N(OP_RAWSessionRequest),
N(OP_RAWSessionResponse),
N(OP_RAWCombined),
N(OP_RAWSessionDisconnect),
N(OP_RAWKeepAlive),
N(OP_RAWSessionStatRequest),
N(OP_RAWSessionStatResponse),
N(OP_RAWPacket),
N(OP_RAWFragment),
N(OP_RAWOutOfOrderAck),
N(OP_RAWAck),
N(OP_RAWAppCombined),
N(OP_RAWOutOfSession),
