#ifndef EQE_PATCH_121504_H
#define EQE_PATCH_121504_H
...
/*0064*/ int32  door_param;		//this may index zone_points
/*0068*/ uint8  unknown0052[12];
};
...
//modern structs which prolly didnt exist in this patch, but we need to fake:
