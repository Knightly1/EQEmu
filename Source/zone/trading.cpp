...
void Client::Trader_ShowItems(){
	...
	//outapp->pBuffer= new uchar[sizeof(Trader_Struct)]; // Not Necessary EQApplicationPacket handles
	//memset(outapp->pBuffer,0,sizeof(Trader_Struct)); // Not Necessary EQApplicationPacket handles
