	...
	void Handle_OP_Deny(const EQApplicationPacket *app);
	...
	void Handle_OP_ConsumeAmmo(const EQApplicationPacket *app);
	...
	void Handle_OP_EmoteAnim(const EQApplicationPacket *app);
	...
	void Handle_OP_StartTribute(const EQApplicationPacket *app);
